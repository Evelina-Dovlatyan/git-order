...
graph LR;
    ...
    staged(+tracked)->>modified: Изменения;
```
...
Conventional Commits предлага     такой формат коммита: <type>: <сообщение>. Первая часть type — это тип изменений. Таких типов достаточно много. Вот два примера:
